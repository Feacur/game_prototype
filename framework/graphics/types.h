...
enum Texture_Type {
	...
	// debugger
	TEXTURE_TYPE_COLOR_DEPTH = TEXTURE_TYPE_COLOR | TEXTURE_TYPE_DEPTH,
	TEXTURE_TYPE_COLOR_STENCIL = TEXTURE_TYPE_COLOR | TEXTURE_TYPE_STENCIL,
	TEXTURE_TYPE_FULL = TEXTURE_TYPE_COLOR | TEXTURE_TYPE_DEPTH | TEXTURE_TYPE_STENCIL,
};
